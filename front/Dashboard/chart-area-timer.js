...
fetch("data.csv")
  ...
  .then(data1 => {
    ...
    for(let i = 0; i < lignes.length; i++) {
      ...
      if (game == 2 && valeur < 0.5) {
        tab[0]++;
      }
      // ajout de 1 à la deuxième case du tableau si la valeur est égale à 0.4
      else if (game == 2 && valeur < 1) {
        tab[1]++;
      }
      // ajout de 1 à la troisième case du tableau si la valeur est supérieure à 2
      else if (game == 2 && valeur < 1.5) {
        tab[2]++;
      }
      else if (game == 2 && valeur < 2) {
        tab[3]++;
      }
      else if (game == 2 && valeur < 2.5) {
        tab[4]++;
      }
      else if (game == 2 && valeur < 3) {
        tab[5]++;
      }
      else if (game == 2 && valeur < 3.5) {
        tab[6]++;
      }
      else if (game == 2 && valeur < 4) {
        tab[7]++;
      }
      else if (game == 2 && valeur < 4.5) {
        tab[8]++;
      }
      else if (game == 2 && valeur < 5) {
        tab[9]++;
      }
      else if (game == 2 && valeur < 5.5) {
        tab[10]++;
      }
      else if (game == 2 && valeur < 6) {
        tab[11]++;
      }
      else if (game == 2 && valeur < 6.5) {
        tab[12]++;
      }
      else if (game == 2 && valeur < 7) {
        tab[13]++;
      }
      else if (game == 2 && valeur < 7.5) {
        tab[14]++;
      }
      else if (game == 2) {
        tab[15]++;
